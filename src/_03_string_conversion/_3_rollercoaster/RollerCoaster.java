...
public class RollerCoaster {
	...
	int heightAsInt=Integer.parseInt(heightToRide);
		...
		if(heightAsInt >= 48) {
			...
			JOptionPane.showMessageDialog(null,"You can go on the coaster but you have to go with someone.");
		}
		else {
			JOptionPane.showMessageDialog(null, "Sorry you have to be at least 42 inches tall to ride the rollar coaster");
		}
